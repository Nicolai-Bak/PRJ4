...
public class PrisninjaDbContext : DbContext
{
    ...
    {
        optionsBuilder.UseSqlServer("Server=tcp:prj4server.database.windows.net,1433;Initial Catalog=PRJ4 Database;Persist Security Info=False;User ID=superadmin;Password=Superpassword1;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
